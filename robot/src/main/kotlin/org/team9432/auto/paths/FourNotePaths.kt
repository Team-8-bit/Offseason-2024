...
object FourNotePaths {
    ...
    private val FOUR_NOTE_SPEAKER_PICKUP =
        Position(2.88.meters, AutoFieldConstants.speakerYCoordinate, 180.0.degrees)/*This next bit is because of a choreo bug, not trying to align better*/.moveX(-3.inches)
